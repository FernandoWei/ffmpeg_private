...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-debug --disable-programs --disable-doc --enable-pic --incdir=/Users/fernando/Development/workspace/ffmpeg_private/include --libdir=/Users/fernando/Development/workspace/ffmpeg_private/lib --target-os=darwin --prefix=/Users/fernando/Development/workspace/ffmpeg_private/ffmpeg
prefix=/Users/fernando/Development/workspace/ffmpeg_private/ffmpeg
LIBDIR=$(DESTDIR)/Users/fernando/Development/workspace/ffmpeg_private/lib
SHLIBDIR=$(DESTDIR)/Users/fernando/Development/workspace/ffmpeg_private/lib
INCDIR=$(DESTDIR)/Users/fernando/Development/workspace/ffmpeg_private/include
BINDIR=$(DESTDIR)${prefix}/bin
DATADIR=$(DESTDIR)${prefix}/share/ffmpeg
DOCDIR=$(DESTDIR)${prefix}/share/doc/ffmpeg
MANDIR=$(DESTDIR)${prefix}/share/man
PKGCONFIGDIR=$(DESTDIR)/Users/fernando/Development/workspace/ffmpeg_private/lib/pkgconfig
...
CFLAGS=   -std=c99 -fomit-frame-pointer -fPIC -pthread -D_GNU_SOURCE=1 -D_THREAD_SAFE -I/usr/local/include/SDL -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
EXTRALIBS=-framework QuartzCore -framework QuartzCore -framework AppKit -framework OpenGL -framework QuartzCore -framework AppKit -framework OpenGL -framework QTKit -framework Foundation -framework QuartzCore -framework CoreVideo -framework Foundation -framework AVFoundation -framework CoreMedia -framework CoreFoundation -framework VideoToolbox -framework CoreMedia -framework CoreVideo -framework CoreFoundation -framework AudioToolbox -framework CoreMedia -framework VideoDecodeAcceleration -framework CoreFoundation -framework QuartzCore -liconv -Wl,-framework,CoreFoundation -Wl,-framework,Security -L/usr/local/lib -lSDLmain -lSDL -Wl,-framework,Cocoa -framework CoreGraphics -lm -lbz2 -lz -pthread -framework CoreServices 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
libavcodec_VERSION=57.55.101
libavcodec_VERSION_MAJOR=57
libavcodec_VERSION_MINOR=55
libavdevice_VERSION=57.0.102
libavdevice_VERSION_MAJOR=57
libavdevice_VERSION_MINOR=0
libavfilter_VERSION=6.62.100
libavfilter_VERSION_MAJOR=6
libavfilter_VERSION_MINOR=62
libavformat_VERSION=57.48.103
